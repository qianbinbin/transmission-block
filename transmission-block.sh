...
[ -z "${LEECHER_CLIENTS+x}" ] && LEECHER_CLIENTS='%FF%1D%FF%FF%FF8I%FF,-GT0002-,-GT0003-,aria2,Baidu,libTorrent (Rakshasa) 0\.13\.8,libtorrent (Rasterbar) 2\.0\.7,QQDownload,Thunder,Xfplay,Xunlei,XunLei'
